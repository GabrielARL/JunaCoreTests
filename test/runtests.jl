...
const SUITES = [
    ...
    (key = "commit-rate-benchmark", file = "commit_code_rate_benchmark.jl",
     ...
     claim = "every receiver supports one-block LDPC geometries at rates 1/16, 1/8, 1/4, and 1/2; the measured SG-1 recorder runs the same five receivers at each rate and tags results with the clean JunaCore source commit",
