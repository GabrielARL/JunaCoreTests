...
Headline values are **PSR / BER at 20 dB**. Click a cell to reveal its configuration, sample rates, packet count, seed, decode time, and bit errors. Expand a site below the table to compare every SNR configuration.
